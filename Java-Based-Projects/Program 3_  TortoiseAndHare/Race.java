...
/**
 *  Program #3
 *  Race class lays out the race and puts the racers in the race
 *  CS160-3
 *  03/06/2022
 *  @author  Patty and Riley Thompson
 */
		...
		while (input != 's' && input != 'S') {
			...
			switch(input){
				...
				case 'H':
					...
					break;
				case 'd':
					racerList.add(new Dragon("Dragon", START_LINE, yPos));
					yPos += RACER_SPACE;
					break;
				case 'D':
					racerList.add(new Dragon("Dragon", START_LINE, yPos));
					...
					break;
				case 'b':
					racerList.add(new Bee("Bee", START_LINE, yPos));
					yPos += RACER_SPACE;
					break;
				case 'B':
					racerList.add(new Bee("Bee", START_LINE, yPos));
					...
					break;
				default:
					JOptionPane.showMessageDialog( this, "This is an invalid racer" );
					break;
				}
