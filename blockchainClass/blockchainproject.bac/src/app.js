const contractAddress = '0x3cbFa68A05c388f7904a9739eE44DE736EbdC6e9';
let contract;
let signer;
...
// }
// async function displayVotingPeriod() {
//   const startTime = new Date('2024-04-30T07:00:00Z');
//   const endTime = new Date('2024-05-01T09:00:00Z');

//   document.getElementById('votingStartTime').innerText = `Voting starts at: ${startTime.toLocaleString()}`;
//   document.getElementById('votingEndTime').innerText = `Voting ends at: ${endTime.toLocaleString()}`;
// }
async function displayVotingPeriod() {
  try {
      const startTime = await contract.votingStartTime();
