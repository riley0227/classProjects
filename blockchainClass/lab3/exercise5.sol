...
contract BaddToken {  
    ...
    function undo_approve(address spender) external returns (bool) {
        // just do what did above in approve and value to 0 instead of amount, as reversing and undoing apporval
        // so allowance now 0
...
contract AMMPool {
    ...
    function swapXY(uint amountX) public {
